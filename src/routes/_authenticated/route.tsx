...
import { Activity, BadgeDollarSign, FileText, LayoutDashboard, Link2, LogOut, Megaphone, Notebook, SearchCheck, Settings, Shield, Trash2 } from "lucide-react";
...
function AuthenticatedLayout() {
  ...
  const adminNav = admin.data?.isAdmin ? [{ to: "/admin", label: "Admin", icon: Shield }, { to: "/admin/search-console", label: "Search Console", icon: SearchCheck }, { to: "/admin/backlinks", label: "Backlinks", icon: Link2 }, { to: "/admin/affiliate", label: "Affiliate", icon: BadgeDollarSign }, { to: "/admin/ads", label: "Ads", icon: Megaphone }, { to: "/admin/operations", label: "Operations", icon: Activity }] : [];
