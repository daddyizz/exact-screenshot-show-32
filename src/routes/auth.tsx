  ...
  head: () => ({
    meta: [
      { title: "Sign in — BlogPilot AI" },
      {
        name: "description",
        content:
          "Sign in or create your BlogPilot AI account to plan, write and schedule SEO blog content on autopilot.",
      },
      { property: "og:title", content: "Sign in — BlogPilot AI" },
      {
        property: "og:description",
        content: "Access your BlogPilot AI workspace and keep your blog publishing on schedule.",
      },
...
function AuthPage() {
  ...
  async function google() {
    ...
    const returnTo = `${window.location.origin}/auth?next=${encodeURIComponent(target)}`;
  ...
  return (
    <main className="grid-backdrop flex min-h-screen items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <Link to="/" className="text-eyebrow mb-6 block text-center hover:text-primary">
          ← BlogPilot AI
        </Link>
        <div className="surface-panel p-6 sm:p-8">
          <h1 className="text-2xl font-bold">Your blog cockpit</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Set up niches, plans and schedules. Free to start.
          </p>
